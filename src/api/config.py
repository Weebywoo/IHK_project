...
async def get_config(repository_name: str) -> RepositoryConfigGetResponse:
    return RepositoryConfigGetResponse(config=config.repositories[repository_name])
...
async def update_config(
    ...
    repository_config: RepositoryConfig = config.update(
        ...
        RepositoryConfig(
            ...
            environment_variables=repository_config_update_request.environment_variables,
